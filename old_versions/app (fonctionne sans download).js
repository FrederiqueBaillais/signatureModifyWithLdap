...
app.post('/saveTemplate', (req, res, next) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        console.log(signatureTemplateTxt + "/" + signatureTemplateTxt + "/" + destinationFolder + "/" + signatureNameTxt + "/" + signatureNameHtm);
        fctExt.downloadOfFile(signatureTemplateTxt, signatureTemplateTxt, destinationFolder, signatureNameTxt, signatureNameHtm);

        //fctExt.copyFileInRemote(signatureTemplateHtm, destHtm);
